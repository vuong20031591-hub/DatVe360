      ...
      children: [
        ...
        GridView.builder(
          ...
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisSpacing: 12,
            mainAxisSpacing: 12,
            childAspectRatio: 1.8, // Tăng từ 1.5 lên 1.8 để có thêm không gian
          ),
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      ...
                      size: 28, // Giảm size từ 32 xuống 28
                    ),
                    const SizedBox(height: 6), // Giảm từ 8 xuống 6
                    Flexible( // Thêm Flexible để text có thể co giãn
                      child: Text(
                    ...
                    Flexible( // Thêm Flexible cho subtitle
                      child: Text(
