    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: _buildFAQList(context, theme)),
        ],
      ),
    );
  }
    ...
    return [
      {
        ...
        'answer':
            'Bạn có thể đặt vé bằng cách: 1) Chọn điểm đi và điểm đến, 2) Chọn ngày khởi hành, 3) Chọn số lượng hành khách, 4) Tìm kiếm và chọn chuyến phù hợp, 5) Điền thông tin hành khách và thanh toán.',
        'helpful': null,
      },
      {
        'category': 'booking',
        ...
        'answer':
            'Có, bạn có thể đặt vé cho người khác. Chỉ cần điền đúng thông tin của hành khách khi đặt vé.',
        'helpful': null,
      },
      {
        'category': 'payment',
      ...
      },
      {
        ...
        'answer':
            'Tất cả giao dịch thanh toán đều được mã hóa SSL 256-bit và tuân thủ tiêu chuẩn bảo mật PCI DSS. Thông tin thẻ của bạn được bảo vệ tuyệt đối.',
        'helpful': null,
      },
      {
        ...
        'answer':
            'Có, bạn có thể hủy vé tùy theo điều kiện của từng hãng. Phí hủy và thời gian hủy sẽ khác nhau. Vui lòng kiểm tra điều kiện hủy trước khi đặt vé.',
        'helpful': null,
      },
      {
        'category': 'cancellation',
        ...
        'answer':
            'Sau khi hủy vé thành công, tiền sẽ được hoàn lại vào tài khoản thanh toán của bạn trong vòng 7-14 ngày làm việc.',
        'helpful': null,
      },
      {
        'category': 'support',
        ...
        'answer':
            'Bạn có thể liên hệ hỗ trợ qua: Hotline: 1900-xxxx (24/7), Email: support@datve360.com, Chat trực tuyến trong ứng dụng.',
        'helpful': null,
      },
      {
        'category': 'support',
        ...
        'answer':
            'Bạn có thể tìm lại mã đặt chỗ bằng cách: 1) Kiểm tra email xác nhận, 2) Đăng nhập vào tài khoản và xem lịch sử đặt vé, 3) Liên hệ hotline với thông tin cá nhân.',
        'helpful': null,
      },
    ];
  }
